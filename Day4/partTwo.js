...
const isAnAnagram = (firstWord, secondWord) => {
  ...
  for (let i = 0; i < firstWord.length; i++) {
    firstWordLetters.push(firstWord.substring(i, i + 1));
  }

  let secondWordLetters = [];
  for (let i = 0; i < secondWord.length; i++) {
    secondWordLetters.push(secondWord.substring(i, i + 1));
  }

  return firstWordLetters.sort().toString() === secondWordLetters.sort().toString();
};
